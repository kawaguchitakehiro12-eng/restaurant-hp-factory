...
import { getSectionUpdates } from "@/data/admin/mock";
...
export default function DashboardTopPage() {
  ...
  const updates = getSectionUpdates(subscription.id);
  ...
  const navCards = [
    {
      ...
      meta: `最終更新 ${formatDate(updates.settings)}`,
    },
    {
      ...
      meta: `最終更新 ${formatDate(updates.topics)}`,
    },
    {
      ...
      detail:
        photoStats.remaining > 0
          ...
          : "推奨枚数に達しています",
      meta: `最終更新 ${formatDate(updates.photos)}`,
    },
    {
      href: "/dashboard/menu",
      title: "メニュー管理",
      ...
      meta: `最終更新 ${formatDate(updates.menu)}`,
    },
    {
