...
import { luxuryCommitmentPhotoClass } from "./luxury-mosaic";
      ...
      <div className="mx-auto max-w-6xl px-6 sm:px-10 md:px-14 lg:px-20 xl:px-24">
        ...
        <StaggerContainer className="luxury-commitment-list">
          {commitments.map((item, index) => {
            ...
            const photoSizeClass = luxuryCommitmentPhotoClass(index);
            ...
            return (
              <StaggerItem key={item.number}>
                ...
                >
                  <figure className={`luxury-commitment-photo ${photoSizeClass}`}>
                    <FlexibleImageFill
                      src={item.image}
                      alt={item.title}
